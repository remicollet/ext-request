...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(AI(setHeaderCallback), 0, 1, IS_NULL, NULL, 0)
    ZEND_ARG_INFO(0, callback)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(AI(getHeaderCallback), 0, 0, IS_NULL, NULL, 0)
ZEND_END_ARG_INFO()
